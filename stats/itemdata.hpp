...
struct ItemData
{
    ...
    void load(int id)
    {
        ...
        mPercentMultiplicativeMovementSpeedMod
                = conf.getNum("Data", "PercentMultiplicativeMovementSpeedMod", 0.0f);
        ...
        mPercentMultiplicativeAttackSpeedMod
                = conf.getNum("Data", "PercentMultiplicativeAttackSpeedMod", 0.0f);
        ...
        m_FlatPhysicalDamageModPerLevel
                = conf.getNum("Data", "rFlatPhysicalDamageModPerLevel", 0.0f);
        ...
        m_PercentMovementSpeedModPerLevel
                = conf.getNum("Data", "rPercentMovementSpeedModPerLevel", 0.0f);
        m_PercentAttackSpeedModPerLevel
                = conf.getNum("Data", "rPercentAttackSpeedModPerLevel", 0.0f);
        ...
        m_FlatArmorPenetrationMod
                = conf.getNum("Data", "rFlatArmorPenetrationMod", 0.0f);
        m_FlatArmorPenetrationModPerLevel
                = conf.getNum("Data", "rFlatArmorPenetrationModPerLevel", 0.0f);
        m_PercentArmorPenetrationMod = conf.getNum("Data", "rPercentArmorPenetrationMod", 0.0f);
        m_PercentArmorPenetrationModPerLevel
                = conf.getNum("Data", "rPercentArmorPenetrationModPerLevel", 0.0f);
        ...
        m_FlatMagicPenetrationModPerLevel
                = conf.getNum("Data", "rFlatMagicPenetrationModPerLevel", 0.0f);
        m_PercentMagicPenetrationMod = conf.getNum( "Data", "rPercentMagicPenetrationMod", 0.0f);
        m_PercentMagicPenetrationModPerLevel
                = conf.getNum("Data", "rPercentMagicPenetrationModPerLevel", 0.0f);
        //Mana
        ...
        mPARStatsArray[0].flatPARRegenModPerLevel
                = conf.getNum("Data", "rFlatMPRegenModPerLevel", 0.0f);
        //Energy
        ...
        mPARStatsArray[1].flatPARRegenModPerLevel
                = conf.getNum("Data", "rFlatEnergyRegenModPerLevel", 0.0f);
        //Souls
        ...
        mPARStatsArray[2].flatPARRegenModPerLevel
                = conf.getNum("Data", "rFlatSoulsRegenModPerLevel", 0.0f);
        //Shield
        ...
        mPARStatsArray[3].flatPARRegenModPerLevel
                = conf.getNum("Data", "rFlatShieldRegenModPerLevel", 0.0f);
